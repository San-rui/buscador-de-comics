...
var _this = this;
var storageSearch = JSON.parse(localStorage.getItem('to-search-storage'));
var url3 = baseUrl1 + "?ts=1&apikey=" + apiKey + "&hash=" + hash + "&offset=0";
var url4 = baseUrl2 + "?ts=1&apikey=" + apiKey + "&hash=" + hash + "&offset=0";
